...
`local-html-editor` は、ローカル HTML をブラウザ上で直接編集するための Chrome 拡張機能です。Chrome で `.html` ファイルを開き、編集モードに入ると、文字、装飾、リンク、画像をその場で変更できます。

AI が生成した単一 HTML、ランディングページ、ニュースレター、履歴書、プロトタイプ、ブランド用ドラフトの修正に向いています。
